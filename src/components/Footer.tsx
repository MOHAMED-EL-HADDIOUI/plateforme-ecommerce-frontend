        ...
        <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
            <div className="row px-xl-5 pt-5">
                <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                    ...
                    <p className="mb-2"><i className="fa fa-map-marker-alt text-info mr-3"></i>123 Street, New York, USA</p>
                    <p className="mb-2"><i className="fa fa-envelope text-info mr-3"></i>info@example.com</p>
                    <p className="mb-0"><i className="fa fa-phone-alt text-info mr-3"></i>+012 345 67890</p>
                </div>
                        ...
                        <div className="col-md-4 mb-5">
                            ...
                            <form action="">
                                <div className="input-group ">
                                    <input type="text" className="form-control m-1" placeholder="Your Email" />
                            ...
                            <div className="d-flex">
                                <a className="btn btn-info btn-square mr-2" href="#"><i className="fab fa-twitter"></i></a>
                                <a className="btn btn-info btn-square mr-2" href="#"><i className="fab fa-facebook-f"></i></a>
                                <a className="btn btn-info btn-square mr-2" href="#"><i className="fab fa-linkedin-in"></i></a>
                                <a className="btn btn-info btn-square" href="#"><i className="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="row border-top mx-xl-5 py-4" style={{ borderColor: "rgba(256, 256, 256, .1) !important" }}>
                <div className="col-md-6 px-xl-0">
                    <p className="mb-md-0 text-center text-md-left text-secondary">
                        &copy; <a className="text-info" href="#">Domain</a>. All Rights Reserved. Designed by
                        <a className="text-info" href="https://htmlcodex.com">HTML Codex</a>
                    </p>
                </div>
                <div className="col-md-6 px-xl-0 text-center text-md-right">
                    <img className="img-fluid" src="/src/assets/img/payments.png" alt="Payments" />
                </div>
            </div>
        </div>
    );
